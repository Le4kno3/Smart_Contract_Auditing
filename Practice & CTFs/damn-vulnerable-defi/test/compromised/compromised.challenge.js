...
describe('Compromised challenge', function () {
    ...
    it('Exploit', async function () {
        ...
        const signer1 = new ethers.Wallet(leakToPrivateKey(privateKey1));
        const signer2 = new ethers.Wallet(leakToPrivateKey(privateKey2));

        //check who the account for the NFT is:
