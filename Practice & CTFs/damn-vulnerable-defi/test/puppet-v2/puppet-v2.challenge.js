 ...
 */
    it('Exploit', async function () {
        ...
        const wethBalance = ethers.utils.formatEther(await attackWeth.balanceOf(attacker.address));
        console.log(wethBalance, " should be >= ", ethers.utils.formatEther(deposit), ". Else, Not enough WETH to take all funds");
