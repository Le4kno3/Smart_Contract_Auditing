...
contract TrustfulOracle is AccessControlEnumerable {
    ...
    constructor(address[] memory sources, bool enableInitialization) {
        ...
        //if the INITIALIZER_ROLE is needed, then only setup the role for initializer
        //I think we need to enable if if we want to initialize the sources. #Note 1#
    ...
    function getMedianPrice(
        ...
        //this is "Median" and not "Average"
        //we need to pic the center most value.
        //to calculate median it first sorts the prices.
